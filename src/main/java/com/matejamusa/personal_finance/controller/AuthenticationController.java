...
public class AuthenticationController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<User> register(@RequestBody SignupAndLoginForm registerUserDto) {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> authenticate(@RequestBody SignupAndLoginForm loginUserDto) {
